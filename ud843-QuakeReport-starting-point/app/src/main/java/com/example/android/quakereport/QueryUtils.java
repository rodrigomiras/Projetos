    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0; i < earthquakeArray.length(); i++){
                ...
                JSONObject propeties = currentEarthquake.getJSONObject("properties");
                String magnitude = propeties.getString("mag");
                String location = propeties.getString("place");
                String time = propeties.getString("time");
